...
namespace DistantObject.SolarSystem.Kopernicus
{
	public class SolarSystem : SolarSystemEngine.Interface
	{
        ...
        double SolarSystemEngine.Interface.GetAltitude(Vector3d worldPos) => KopernicusStar.Current.sun.GetAltitude(worldPos);
        CelestialBody SolarSystemEngine.Interface.GetSun() => KopernicusStar.Current.sun;
    }
}
